...
// Stopgap manual pra um buraco real: runPluginMigrations só roda dentro de installPlugin
...
// não aplica essas migrations sozinho — nem no build, nem reinstalando pela tela de plugins.
//
